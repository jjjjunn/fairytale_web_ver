...
class EmailServiceWelcome:
    def send_email(
        ...
        <html>
            <body>
                <p><strong>동화 생성앱</strong> 회원가입을 환영합니다!</p>
                <p>앞으로 많은 이용 부탁 드리며, 사용에 불편함이 있거나, 제안사항이 있으시면</p>
                <p>언제든 피드백 부탁 드립니다! 👍🏻</p>
                <p><a href="http://localhost:8501" target="_blank">✅ 로그인하러 가기</a></p>
            </body>
        </html>
        """
...
class EmailServiceBye:
    def send_email(
        ...
        <html>
            <body>
                <p><strong>동화생성 앱</strong> 회원 탈퇴가 완료되었습니다.</p>
                <p>그동안 고객님의 이용에 감사 드리며, 더 나은 서비스가 되도록 노력하겠습니다.🙇🏻‍♀️</p>
                <p>곧 고객님을 다시 만날 날을 기다리겠습니다. 🙋🏻‍♂️</p>
                <p><a href="http://localhost:8501" target="_blank">✅ 회원가입하러 가기</a></p>
            </body>
        </html>
        """
    ...
    def send_email(
        ...
        <html>
            <body>
                ...
                <p><a href="http://localhost:8501/settings" target="_blank">✅ 로그인하러 가기</a></p>
            </body>
        </html>
        """
    ...
    def send_email(
        ...
        <html>
            <body>
                ...
                <p><a href="http://localhost:8501/settings" target="_blank">➡️ 비밀번호 변경하러 가기</a></p>
            </body>
        </html>
        """
